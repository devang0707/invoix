...
export default function AllInvoiceScreen() {
    ...
    const [cityStateZipTwo, setCityStateZipTwo] = useState('');
    ...
    const submit = async () => {
        const invoice = {
            ...
            billFrom: {
                ...
                cityStateZipTwo: cityStateZipTwo
            },
            items: rows.map(row => ({
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 20 }} className='flex-1 bg-neutral-900'>
            ...
            <ScrollView className="max-w-3xl text-white mx-auto my-[30px] border border-gray-300 p-5">
                ...
                <View>
                    ...
                    <TextInput onChangeText={setNameTwo} placeholder="Name" className="w-[80vw] my-2 p-2 border border-gray-300 rounded bg-white" />
                    <TextInput onChangeText={setAddressTwo} placeholder="Street Address" className="w-[80vw] my-2 p-2 border border-gray-300 rounded bg-white" />
                    <TextInput onChangeText={setCityStateZipTwo} placeholder="City, State, ZIP" className="w-[80vw] my-2 p-2 border border-gray-300 rounded bg-white" />
                </View>
